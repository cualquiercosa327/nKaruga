...
#define Texture_nKaruga SDL_Surface
...
extern unsigned short getPixelUnsafe(SDL_Surface*, unsigned int, unsigned int);
extern unsigned short getPixel(SDL_Surface*, unsigned int, unsigned int);
...
//#define Get_Size_Image(a, b, c, w, h) SDL_QueryTexture(a, b, c, w, h)
